    ...
    <div className="max-w-3xl flex flex-col mx-auto size-full">
      ...
      <main id="content">
        <div className="text-center py-10 px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-gray-600">Oops, bạn không có quyền truy cập trang này.</p>
          <p className="text-gray-600">Vui lòng liên hệ với quản trị viên để được hỗ trợ.</p>
