...
export default function ErrorPage() {
    ...
    // Kiểm tra nếu error có đúng cấu trúc mong muốn
    const error: Partial<IBackendResponse<unknown>> =
        rawError && typeof rawError === "object" && "statusCode" in rawError
  ...
  <main id="content">
    <div className="text-center py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-5 flex flex-col justify-center items-center gap-2 sm:flex-row sm:gap-3">
        <NavLink className="w-full sm:w-auto py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" to="/">
