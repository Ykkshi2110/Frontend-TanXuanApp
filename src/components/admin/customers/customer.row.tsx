...
const CustomerRow = (props: IProps) => {
  const { customerData, onEditClick, onDeleteClick } = props;
  ...
  return (
    <tr>
      ...
      <td className="px-4 py-3 whitespace-nowrap text-xs text-black-800">
        {customerData?.createdAt ? dayjs.unix(Number(customerData?.createdAt)).format("DD/MM/YYYY") : ""}
      </td>
